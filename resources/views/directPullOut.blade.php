...
if($company == "NBFI"){
    ...
    <p>Subject: DIRECT PULL-OUT LETTER </p><br><br>


    <p>Dear Sir/Ma'am:</p>
    <p>We hereby authorize our office representative, whose name is listed below, to pull out specific stocks in your store in sealed boxes between <span id="formattedDate"></span> {{ $dateStart }}, and {{ $dateEnd }}.</p><br>
        <div class="mx-24">
