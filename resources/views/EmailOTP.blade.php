...
<body bgcolor="#edf2f7" text="#3b3f44" link="#ffffff" yahoo="fix" style="background-color: #edf2f7;">
        ...
        <tr>
            <td align="center" class="r0-c">
                <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="600" class="r1-o"
                    ...
                    <tr>
                        <td valign="top" class="r2-i" style="background-color: #edf2f7;">
                                ...
                                <tr>
                                    <td class="r3-c" align="center">
                                        <table cellspacing="0" cellpadding="0" border="0" role="presentation"
                                            ...
                                            <tr>
                                                <td class="r5-i"
                                                    style="background-color: #ffffff; padding-bottom: 20px; padding-left: 20px; padding-right: 20px; padding-top: 20px;">
                                                                                                ...
                                                                                                <td align="left"
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <h4 class="default-heading4"
                                                                                                            ...
                                                                                                            <span
                                                                                                                style="font-family: Arial; font-size: 18px;">Hello</span>!
                                                                                                        </h4>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                                ...
                                                                                                <td align="center"
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <h2 class="default-heading2"
                                                                                                            ...
                                                                                                            <span
                                                                                                                style="font-family: Arial; font-size: 32px;">{{ $data['code']}}</span>
                                                                                                        </h2>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
