...
<body >
    ...
    <p>This is a request from our office to kindly allow our personnel <span style="font-weight: bold">(see below)</span> to perform a pull-out of item(s)/hanger(s)/fixture(s) from your store/warehouse between <span id="formattedDate"></span> {{ $dateStart }}, and {{ $dateEnd }}.</p><br>
    ...
    <div class="mx-24">
                <table id="branchMaintenanceTable" class="w-full text-xs text-left text-gray-500 dark:text-gray-400 border-collapse border border-slate-800">
                    ...
                    <tbody>
                        ...
                        <tr class="w-full">
                                <td scope="col" class='py-1 px-3 border border-slate-300'>{{ $driver->name }}</td>
                                <td scope="col" class='py-1 px-3 border border-slate-300'>{{ $driver->position }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    <p>Should you have question or clarification, you may contact us at telephone number (02)877-83-51.</p>
    <p>Thank you!</p><br>
